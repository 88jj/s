...
const 持续时间 = 17; // s
const 成功关键字 = '';
let 启用任务定时 = 0; // 0 不启用 1 启用
let 任务定时时间 = '19:59:57:900'; // 时:分:秒.毫秒
...
let reqArr = [
  {
  "url": "https://mkt-gateway.tuhu.cn/mkt-promotion-award-service/coupon/receiveCoupon",
  "method": "POST",
  "headers": {
    "Connection": "keep-alive",
    "Accept-Encoding": "gzip,compress,br,deflate",
    "currentPage": "packages/kirin/index",
    "distinct_id": "1693137269104-8533028-075510006ae243-13649335",
    "authType": "oauth",
    "Content-Type": "application/json",
    "api_level": "2",
    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.40(0x18002831) NetType/WIFI Language/zh_CN",
    "platformSource": "uni-app",
    "Authorization": "Bearer 41bc55301a05444887cab8aee01f5947",
    "Host": "mkt-gateway.tuhu.cn",
    "Referer": "https://servicewechat.com/wx27d20205249c56a3/759/page-frame.html",
    "blackbox": "gMPSR1693212628ageLUxsOa30",
    "Content-Length": "132"
  },
  "body": "{\"channel\":\"wx_app\",\"activityPageId\":\"3azo1odwnF27E\",\"type\":1,\"activityComponentId\":\"3Ir5p9pgOJBnG\",\"componentUuid\":\"3EVmX60feFcEJ\"}"
}
];
...
!(async () => {
  ...
  if (执行单次) {
    ...
    await $.wait(reqArr.length * 200 + 1500); // qx保活
  } else {
